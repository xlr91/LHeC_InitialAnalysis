...
./Process /disk/moose/general/asc/Y4_LHeC_2021/Samples_Py8303_Delphes3.4.3pre06/LHeC_CC_Z4l.10k.Delphes.root bakgndZ.root z > bakgndZ.log 2>&1
rm make.out;
root -l -e '.x Compare.cxx()' -b -q > Compare.log 2>&1 ;
